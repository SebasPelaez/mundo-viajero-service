...
public class EventDAOImpl extends BaseDAO implements IEventDAO {
	...
	@Override
	public int numberOfAtendees(Long eventId) {
		String queryString = "select COUNT(a) from Atendee a where a.primary.eventId = :eventId";
		TypedQuery<Long> query = getCurrentSession().createQuery(queryString);
