...
public class FieldConstants {
	...
	public static final String PERSON_STATEID = "stateId";
	public static final int PERSON_STATEID_LENGTH = 5;
	public static final boolean PERSON_STATEID_OBLIGATORY = true;
