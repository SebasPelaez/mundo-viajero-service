...
public class StateDAOImplTest2 {
  ...
  public void testGetAllStates() {
    ...
    //when(iStateDAO.getAllStates()).thenReturn(statesDTO);
    
    List<StateDTO> actualStatesDTO = iStateDAO.getAllStates();
